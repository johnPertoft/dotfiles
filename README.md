...
Pushes to `main`, pull requests targeting `main`, and manual runs use this
matrix. Documentation-only pushes/PRs are
...
five-minute policy for pushes/PRs. The closure size limits remain unchanged.
